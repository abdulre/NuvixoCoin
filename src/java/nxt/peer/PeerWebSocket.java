...
public class PeerWebSocket {
    ...
    static {
        try {
            ...
            // Jetty 11: WebSocketClient implements WebSocketPolicy directly — no .getPolicy()
            // indirection, and setIdleTimeout takes a Duration instead of a long millis value.
            peerClient.setIdleTimeout(Duration.ofMillis(Peers.webSocketIdleTimeout));
