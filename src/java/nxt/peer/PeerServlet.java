...
public final class PeerServlet extends JettyWebSocketServlet {
    ...
    public void configure(JettyWebSocketServletFactory factory) {
        // Jetty 11: JettyWebSocketServletFactory implements the policy setters directly —
        // no .getPolicy() indirection, and setIdleTimeout takes a Duration.
        factory.setIdleTimeout(Duration.ofMillis(Peers.webSocketIdleTimeout));
