...
class NxtDbVersion extends DbVersion {
    ...
    protected void update(int nextUpdate) {
        switch (nextUpdate) {
            case 1:
                apply("CREATE TABLE IF NOT EXISTS block (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, version INT NOT NULL, "
            ...
            case 3:
                apply("CREATE TABLE IF NOT EXISTS transaction (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 4:
                // H2 2.x requires the FK target column to have an actual UNIQUE or
                // PRIMARY KEY constraint, not just a unique index — a plain unique
                // index (which was sufficient in H2 1.x) is no longer accepted when
                // referenced_transaction's FOREIGN KEY (see case 230) points at this
                // column. Using a named constraint instead of a plain index still
                // creates a backing index automatically, so lookup performance is
                // unchanged — this only changes how the uniqueness guarantee is
                // declared, not the runtime behavior.
                apply("ALTER TABLE transaction ADD CONSTRAINT transaction_id_idx UNIQUE (id)");
            case 5:
            ...
            case 11:
                apply("CREATE TABLE IF NOT EXISTS alias (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 15:
                apply("CREATE TABLE IF NOT EXISTS alias_offer (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 17:
                apply("CREATE TABLE IF NOT EXISTS asset (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 19:
                apply("CREATE TABLE IF NOT EXISTS trade (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, asset_id BIGINT NOT NULL, block_id BIGINT NOT NULL, "
            ...
            case 23:
                apply("CREATE TABLE IF NOT EXISTS ask_order (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 27:
                apply("CREATE TABLE IF NOT EXISTS bid_order (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "asset_id BIGINT NOT NULL, price BIGINT NOT NULL, transaction_index SMALLINT NOT NULL, "
                        + "transaction_height INT NOT NULL, "
                        + "quantity BIGINT NOT NULL, creation_height INT NOT NULL, height INT NOT NULL, "
                        + "latest BOOLEAN NOT NULL DEFAULT TRUE)");
            ...
            case 31:
                apply("CREATE TABLE IF NOT EXISTS goods (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, seller_id BIGINT NOT NULL, "
                        + "name VARCHAR NOT NULL, description VARCHAR, parsed_tags VARCHAR ARRAY, has_image BOOLEAN NOT NULL, "
            ...
            case 35:
                apply("CREATE TABLE IF NOT EXISTS purchase (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, buyer_id BIGINT NOT NULL, "
            ...
            case 40:
                apply("CREATE TABLE IF NOT EXISTS account (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 42:
                apply("CREATE TABLE IF NOT EXISTS account_asset (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 44:
                apply("CREATE TABLE IF NOT EXISTS account_guaranteed_balance (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 46:
                apply("CREATE TABLE IF NOT EXISTS purchase_feedback (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, feedback_data VARBINARY NOT NULL, "
            ...
            case 48:
                apply("CREATE TABLE IF NOT EXISTS purchase_public_feedback (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, public_feedback "
            ...
            case 50:
                apply("CREATE TABLE IF NOT EXISTS unconfirmed_transaction (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, expiration INT NOT NULL, "
            ...
            case 52:
                apply("CREATE TABLE IF NOT EXISTS asset_transfer (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
            ...
            case 62:
                apply("CREATE TABLE IF NOT EXISTS tag (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, tag VARCHAR NOT NULL, in_stock_count INT NOT NULL, "
            ...
            case 65:
                apply("CREATE TABLE IF NOT EXISTS currency (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 68:
                apply("CREATE TABLE IF NOT EXISTS account_currency (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 70:
                apply("CREATE TABLE IF NOT EXISTS currency_founder (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, currency_id BIGINT NOT NULL, "
            ...
            case 72:
                apply("CREATE TABLE IF NOT EXISTS currency_mint (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 74:
                apply("CREATE TABLE IF NOT EXISTS buy_offer (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL,"
            ...
            case 77:
                apply("CREATE TABLE IF NOT EXISTS sell_offer (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "rate BIGINT NOT NULL, unit_limit BIGINT NOT NULL, supply BIGINT NOT NULL, expiration_height INT NOT NULL, "
                        + "creation_height INT NOT NULL, transaction_index SMALLINT NOT NULL, transaction_height INT NOT NULL, height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 78:
            ...
            case 80:
                apply("CREATE TABLE IF NOT EXISTS exchange (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, transaction_id BIGINT NOT NULL, currency_id BIGINT NOT NULL, block_id BIGINT NOT NULL, "
            ...
            case 85:
                apply("CREATE TABLE IF NOT EXISTS currency_transfer (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, currency_id BIGINT NOT NULL, "
            ...
            case 99:
                apply("CREATE TABLE IF NOT EXISTS currency_supply (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 101:
                apply("CREATE TABLE IF NOT EXISTS public_key (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 107:
                apply("CREATE TABLE IF NOT EXISTS vote (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, " +
            ...
            case 110:
                apply("CREATE TABLE IF NOT EXISTS poll (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 111:
                apply("CREATE TABLE IF NOT EXISTS poll_result (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, poll_id BIGINT NOT NULL, "
                        + "result BIGINT, weight BIGINT NOT NULL, height INT NOT NULL)");
            case 112:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 113:
                apply("CREATE TABLE IF NOT EXISTS phasing_vote (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, vote_id BIGINT NOT NULL, "
                        + "transaction_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, "
                        + "height INT NOT NULL)");
            case 114:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_voter (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, "
                        + "transaction_id BIGINT NOT NULL, voter_id BIGINT NOT NULL, "
                        + "height INT NOT NULL)");
            case 115:
            ...
            case 128:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_result (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 136:
                apply("CREATE TABLE IF NOT EXISTS account_info (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 138:
                apply("CREATE TABLE IF NOT EXISTS prunable_message (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, sender_id BIGINT NOT NULL, "
            ...
            case 144:
                apply("CREATE TABLE IF NOT EXISTS tagged_data (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                        + "name VARCHAR NOT NULL, description VARCHAR, tags VARCHAR, parsed_tags VARCHAR ARRAY, type VARCHAR, data VARBINARY NOT NULL, "
            ...
            case 149:
                apply("CREATE TABLE IF NOT EXISTS data_tag (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, tag VARCHAR NOT NULL, tag_count INT NOT NULL, "
                        + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 150:
            ...
            case 152:
                apply("CREATE TABLE IF NOT EXISTS tagged_data_timestamp (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, timestamp INT NOT NULL, "
                        + "height INT NOT NULL, latest BOOLEAN NOT NULL DEFAULT TRUE)");
            case 153:
            ...
            case 156:
                apply("CREATE TABLE IF NOT EXISTS account_lease (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, lessor_id BIGINT NOT NULL, "
            ...
            case 187:
                apply("CREATE TABLE IF NOT EXISTS exchange_request (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 193:
                apply("CREATE TABLE IF NOT EXISTS account_ledger (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 196:
                apply("CREATE TABLE IF NOT EXISTS tagged_data_extend (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, "
            ...
            case 202:
                apply("CREATE TABLE IF NOT EXISTS shuffling (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, holding_id BIGINT NULL, holding_type TINYINT NOT NULL, "
            ...
            case 207:
                apply("CREATE TABLE IF NOT EXISTS shuffling_participant (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, shuffling_id BIGINT NOT NULL, "
            ...
            case 210:
                apply("CREATE TABLE IF NOT EXISTS shuffling_data (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, shuffling_id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
            ...
            case 213:
                apply("CREATE TABLE IF NOT EXISTS phasing_poll_linked_transaction (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, "
            ...
            case 217:
                apply("CREATE TABLE IF NOT EXISTS account_control_phasing (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, account_id BIGINT NOT NULL, "
            ...
            case 220:
                apply("CREATE TABLE IF NOT EXISTS account_property (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, recipient_id BIGINT NOT NULL, setter_id BIGINT, "
            ...
            case 225:
                apply("CREATE TABLE IF NOT EXISTS asset_history (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
            ...
            case 230:
                apply("CREATE TABLE IF NOT EXISTS referenced_transaction (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, transaction_id BIGINT NOT NULL, "
            ...
            case 233:
                apply("CREATE TABLE IF NOT EXISTS asset_dividend (db_id BIGINT GENERATED BY DEFAULT AS IDENTITY, id BIGINT NOT NULL, asset_id BIGINT NOT NULL, "
